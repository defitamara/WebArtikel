...
class ArtikelController extends Controller
{
    ...
    public function index()
    {
        ...
        $artikel = Artikel::join('tb_penulis', 'tb_penulis.id_penulis', '=', 'tb_artikel.id_penulis')
                   ...
                   ->where('tb_penulis.id',$id)
                   ->get();
        return view('penulis.dt_artikel.index', compact('artikel'));
    }
    ...
    public function cetakpdf()
    {
    	...
    	$pdf = PDF::loadview('penulis/dt_artikel/cetakpdf',['artikel'=>$artikel]);
    	return view('penulis.dt_artikel.cetakpdf',compact('artikel'));
    }

    public function create()
    {
        $penulis = Penulis::all();
        return view('penulis.dt_artikel.create',compact('penulis'));
    }
    ...
    public function detail($id)
    {
        $artikel = Artikel::join('tb_penulis', 'tb_penulis.id_penulis', '=', 'tb_artikel.id_penulis')
                   ...
                   ->where('id_artikel',$id)
                   ->get();
        return view('penulis.dt_artikel.detail',compact('artikel'));
    }
    ...
    public function edit($id)
    {
        ...
        $penulis = Penulis::all();
        return view('penulis.dt_artikel.edit',compact('artikel','penulis'));
    }

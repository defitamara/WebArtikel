@extends('penulis/layouts.template')
          ...
          <!-- ============================================================== -->
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="{{ route('dt_artikel.create') }}" class="card-title">
                    <button type="button" class="btn btn-primary">
                      <i class="mdi mdi-plus-box-outline"></i>
                      Tambah Data
                    </button>
                  </a>
                  <a href="/cetakpdf/dt_artikel" class="card-title" target="_blank">
                    ...
                    >
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('dt_artikel.edit',$item->id_artikel) }}" >
                              <button type="button" class="btn btn-cyan btn-sm text-white">
                              <span class="fas fa-pencil-alt"></span>
                            </button></a>
                          
                          <form action="{{ route('dt_artikel.destroy',$item->id_artikel)}}" method="POST">
                            @csrf
                                @method('DELETE')
